...
import com.hungryduck.viewmodel.NewsViewHolderDTO;
import com.hungryduck.viewmodel.SellerNewsEventFullDTO;
import com.hungryduck.viewmodel.SellerNewsEventListDTO;
...
public class SellerTabTriNews extends Fragment {
    ...
    private SellerNewsParsing parser;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle b) {
        ...
        parser = new SellerNewsParsing();     // 파싱하는 객체 생성
